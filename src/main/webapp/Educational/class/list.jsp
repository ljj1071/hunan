...
<body>
	...
	<div class="div_head" style="width: 100%;text-align:center;">
		<span> <span style="float:left">当前位置是：教务中心-》班级管理</span> <span
            ...
            <a style="text-decoration: blink" href="selectadd">【新增班级】&emsp;&emsp;&emsp;&emsp;</a>
		</span>
		</span>
	</div>
					...
					<tr>
						<td colspan="20" style="text-align: center;">
							<a style="text-decoration: none;" href="#">
								<a href="/Educational/class/selectall?name=${name}">首页</a>
								<a href="/Educational/class/selectall?index=${pi.prePage==0?1:pi.prePage}&name=${name}">上一页</a>
								<c:forEach begin="1" end="${pi.pages}" var="i">
									<a href="/Educational/class/selectall?index=${i}&name=${name}">${i}</a>
								</c:forEach>
								<a href="/Educational/class/selectall?index=${pi.nextPage==0?pi.pages:pi.nextPage}&name=${name}">下一页</a>
								<a href="/Educational/class/selectall?index=${pi.pages}&name=${name}">尾页</a>
								共${pi.total}条
								每页显示
