               ...
               <tr>
                    ...
                    <td>
                        <select name="deptid">
                            ...
                            <c:forEach items="${dlist}" var="dli">
                                <option value="${dli.departid}">
                                    ${dli.departname}
                                </option>
                            </c:forEach>
				...
				<tr>
				 ...
				 <tr>
                    ...
                    <td>
						<input type="text" name="classbegin" value="2016/6/6" /></td>
                </tr>
                <tr>
                    <td>毕业时间：<span style="color:red">*</span>：</td>
                    <td>
						<input type="text" name="classend" value="2018/8/8" /></td>
                </tr>
				<tr>
