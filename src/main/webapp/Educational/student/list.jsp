                    ...
                    <tr id="product1">
						...
						<td align="center">
							...
							<a href="javascript:void(0)"
							   onclick="del(${stu.studentid});return false"
							   class="tablelink"> 退学</a>
							</c:if>
				...
				<tr>
					<td colspan="20" style="text-align: center;">
						<a style="text-decoration: none;" href="#">
							<a href="/Educational/student/selectall?name=${name}&stuno=${stuno}&sex=${sex}">首页</a>
							<a href="/Educational/student/selectall?index=${pi.prePage==0?1:pi.prePage}&name=${name}&stuno=${stuno}&sex=${sex}">上一页</a>
							<c:forEach begin="1" end="${pi.pages}" var="i">
								<a href="/Educational/student/selectall?index=${i}&name=${name}&stuno=${stuno}&sex=${sex}">${i}</a>
							</c:forEach>
							<a href="/Educational/student/selectall?index=${pi.nextPage==0?pi.pages:pi.nextPage}&name=${name}&stuno=${stuno}&sex=${sex}">下一页</a>
							<a href="/Educational/student/selectall?index=${pi.pages}&name=${name}&stuno=${stuno}&sex=${sex}">尾页</a>
							共${pi.total}条
							每页显示
